  ...
  return (
    <div className="space-y-5 max-w-5xl">
      ...
      <header className="flex items-start gap-3">
        ...
        <div>
          <h1 className="font-display text-2xl font-extrabold text-ink">{game?.title ?? '小游戏'}</h1>
        ...
        {prev ? (
          <Link href={`/student/course/g/${prev.game.slug}`} className="kid-button-ghost !px-4 !py-3">
            ...
            <span className="text-left leading-tight">
              <span className="block text-[11px] text-ink-soft">上一个</span>
        ...
        {next ? (
          <Link href={`/student/course/g/${next.game.slug}`} className="kid-button-primary !px-5 !py-3">
            <span className="text-right leading-tight">
              <span className="block text-[11px] text-white/80">下一个游戏</span>
