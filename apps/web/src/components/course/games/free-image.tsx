...
export function FreeImageGame() {
  ...
  return (
    <div className="space-y-4">
      {loading && <AiProgress label="AI 正在画你的图…" className="sticky top-2 z-10 shadow-sm" />}

      <div className="kid-card-pink">
        <p className="text-sm font-semibold text-ink-soft leading-relaxed">
          ✨ 不用点关键词，直接用你自己的话描述想画什么——越具体越好！左边写下想法，右边会显示 AI 画出来的作品。
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-[1fr_300px] xl:grid-cols-[1fr_340px] gap-4 items-start">
        <div className="kid-card space-y-4">
          <div>
            <label className="text-sm font-bold">💭 我想画什么？</label>
            <textarea
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            <div>
              <label className="text-sm font-bold">尺寸</label>
            ...
            <div>
              <label className="text-sm font-bold">张数</label>
        ...
        <div className="space-y-4 lg:sticky lg:top-4">
          <StudentAssetLibraryEntry defaultTab="image" hint="查看以前画过的所有图片" />

          {prompt.trim() && (
            <div className="kid-card">
              <h3 className="font-bold mb-2 text-sm">📝 你的想法</h3>
